...
#
# 문구는 담백한 서술문으로 통일한다. 주장("진짜와 구분되지 않아요")이나
# 이야기 만들기("일어날 이유가 생겼어요") 는 쓰지 않는다.
SCREENS = [
    ("p_incoming.png", "01-incoming", "가짜 전화가<br>걸려옵니다"),
    ("p_home.png", "02-home", "이름과 시간만<br>정하면 됩니다"),
    ("p_active.png", "03-active", "받은 뒤 화면도<br>그대로입니다"),
    ("p_ringsheet.png", "04-ringtone", "벨소리 없이<br>진동만 울립니다"),
]
